...
namespace FloristeriaWeb.Migrations
{
    ...
    [Migration("20260506073029_RecargaFlores")]
    partial class RecargaFlores
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FloristeriaWeb.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Activo = true,
                            Descripcion = "Coronas, cruces y arreglos solemnes de condolencias.",
                        ...
                        new
                        {
                            Id = 2,
                            Activo = true,
                            Descripcion = "Ramos elegantes diseñados para expresar amor y aniversario.",
                            Nombre = "Ramos Románticos"
                        },
                        new
                        {
                            Id = 3,
                            Activo = true,
                            Descripcion = "Arreglos alegres y coloridos para celebraciones especiales.",
                            Nombre = "Detalles de Cumpleaños"
                        },
                        new
                        {
                            Id = 4,
                            Activo = true,
                            Descripcion = "Plantas vivas y flores exóticas para interiores y decoración duradera.",
                            Nombre = "Plantas Exóticas"
                        });
                });
